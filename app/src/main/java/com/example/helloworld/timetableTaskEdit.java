...
public class timetableTaskEdit extends AppCompatActivity {
    private timetableTask t;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        String day = getIntent().getStringExtra("Date"); // now this is the day name
        t.setID(database.getNextID(day));
        ...
        if (getIntent().hasExtra("Task")) {
            ...
            background.setColor(t.getColorID(timetableTaskEdit.this));
            ...
            submit.setOnClickListener(v-> {
                ...
                database.updateTask(t, day);
                Toast.makeText(this, "Task updated successfully", Toast.LENGTH_SHORT).show();
                finish();
            });

            delete.setOnClickListener(v-> {
                database.deleteTask(t.getID(), day);
